...
public class LoginBean implements Serializable {
    ...
    public void showInfo() {
        reg = FacesContext.getCurrentInstance().getExternalContext().getFlash().get("reg");
        if (reg != null)
            Messages.addGlobal(FacesMessage.SEVERITY_INFO, "Registration completed successfully");
    }
